  ...
  return (
    <>
      ...
      >
        ...
        <Button
          variant="outline"
          className="w-48 p-8 flex font-semibold text-2xl rounded-full mt-14 bg-[#59F8E8] shadow-xl  drop-shadow-[0px_2px_5px_rgba(225,225,225)]"
        >
          Play Again
        </Button>
        <Button
          variant="outline"
          className="w-32 p-5 flex font-semibold text-2xl rounded-full mt-5 bg-[#59F8E8] shadow-2xl  drop-shadow-[0px_2px_5px_rgba(225,225,225)]"
        >
          Quit
        </Button>
      </div>
